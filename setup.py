...
setup(
    ...
    description='Set dynaconf environment when running pytest',
    long_description=read('README.rst'),
    py_modules=['pytest_dynaconf'],
    python_requires='>=3.5',
    install_requires=['pytest>=3.5.0', 'dynaconf'],
    classifiers=[
